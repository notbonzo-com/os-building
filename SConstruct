...
PhonyTargets(HOST_ENVIRONMENT, 
             run=['./sc/run.sh', HOST_ENVIRONMENT['imageType'], image[0].path],
             debug=['./sc/debug.sh', HOST_ENVIRONMENT['imageType'], image[0].path],
             bochs=['./sc/bochs.sh', HOST_ENVIRONMENT['imageType'], image[0].path])
